...
export namespace FeaturesModule {
  ...
  export type RoomEvent = Pick<Types.RoomEvent, DefinedFields['RoomEvent']>;
  ...
  export type RoomEventResolvers = Pick<Types.RoomEventResolvers, DefinedFields['RoomEvent'] | '__isTypeOf'>;
